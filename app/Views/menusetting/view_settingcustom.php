...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Custom</h3>
              <p class="text-sm mb-0">
                Berisi data custom untuk front end
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahsettingcustom" 
                        onClick="generatekodesettingcustom()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-settingcustom">
    ...
    <?= $this->include('menusetting/add_settingcustom'); ?>
    <?= $this->include('menusetting/edit_settingcustom'); ?>
<?= $this->endSection(); ?>