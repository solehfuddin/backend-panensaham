    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="dashboard.html">
          <img src="../../assets/img/brand/ps-logo.png" class="navbar-brand-img" alt="...">
        </a>
        <div class="ml-auto">
          <!-- Sidenav toggler -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-examples">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="../examples/login.html" class="nav-link">Price</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="../components/grid.html" class="nav-link">User</a>
                  </li>
                  <li class="nav-item">
                    <a href="../components/notifications.html" class="nav-link">Administrator</a>
                  </li>
                  <!-- <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-forms">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="../forms/validation.html" class="nav-link">News</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-maps">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../maps/google.html" class="nav-link">Question</a>
                  </li>
                  <li class="nav-item">
                    <a href="../maps/vector.html" class="nav-link">Subscribe</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="navbar-another">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="../tables/datatables.html" class="nav-link">Custom</a>
                  </li>
                </ul>
              </div>
            </li>
