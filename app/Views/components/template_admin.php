...
<head>
  ...
  <title>Administrator | PanenSaham</title>
  ...
  <!-- Argon CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>/assets/css/argon.min-v=1.0.0.css" type="text/css">
  <!-- Google Tag Manager -->
...
<body>
  ...
  <!-- Custom JS -->
  <script src="<?= base_url() ?>/assets/js/package/feature.js"></script>
  <script src="<?= base_url() ?>/assets/js/account/userlevel.js"></script>
  <script src="<?= base_url() ?>/assets/js/account/member.js"></script>
  <script src="<?= base_url() ?>/assets/js/information/category.js"></script>
  <script src="<?= base_url() ?>/assets/js/information/type.js"></script>
  <script src="<?= base_url() ?>/assets/js/media/filtermed.js"></script>
  <script src="<?= base_url() ?>/assets/js/setting/benefit.js"></script>
