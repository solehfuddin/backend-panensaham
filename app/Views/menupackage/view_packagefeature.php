...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Fitur Paket</h3>
              <p class="text-sm mb-0">
                Data ini berisi informasi fitur - fitur yang tersedia berdasarkan level pada member
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahpackagefeature">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-packagefeature">
    ...
    <?= $this->include('menupackage/add_packagefeature'); ?>
    <?= $this->include('menupackage/edit_packagefeature'); ?>
<?= $this->endSection(); ?>