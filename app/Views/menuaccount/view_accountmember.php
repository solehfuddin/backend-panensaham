          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <p class="text-sm mb-0">
                Berisi informasi jenis member seperti: member anggota, member komunitas atau bahkan member baru
              </p>
            ...
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-accountmember">
                <thead class="thead-light">
                    <tr>
                    <th>No</th>
                    <th>Kode Jenis Member</th>
                    <th>Keterangan</th>
                    <th>Aksi</th>
                    </tr>
                </thead>
