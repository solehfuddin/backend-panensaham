    ...
    $('.formModaltambahsettingbenefit').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodaltambahsettingbenefit').html('<i class="fa fa-spin fa-spinner"> Processing</i>');
            },
            complete: function() {
    ...
    $('.formModalubahsettingbenefit').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodalubahsettingbenefit').html('<i class="fa fa-spin fa-spinner"> Processing</i>');
            },
            complete: function() {
