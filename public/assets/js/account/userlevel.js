//Datatables server side level user
...
//Fungsi generate kode level user
    ...
    $('.formModaltambahaccountuserlevel').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodaltambahaccountuserlevel').html('<i class="fa fa-spin fa-spinner"> Processing</i>');
            },
            complete: function() {
    ...
    $('.formModalubahaccountuserlevel').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodalubahaccountuserlevel').html('<i class="fa fa-spin fa-spinner"> Processing</i>');
            },
            complete: function() {
