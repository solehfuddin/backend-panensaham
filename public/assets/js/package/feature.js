    ...
    $('.formModaltambahpackagefeature').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodaltambahpackagefeature').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
    ...
    $('.formModalubahpackagefeature').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodalubahpackagefeature').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
